...
### Планируется внедрить технологии машинного обучения, возможность анализировать стиль игрока и адаптироваться под паттерны действий. Это позволит боту более грамотно принимать решения, в первую очередь за счет обученных весов вместо интуитивно подобранных. 

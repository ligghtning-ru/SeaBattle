...
### Планируется внедрить: технологии машинного обучения, возможность анализировать стиль игрока. Это позволит боту более грамотно принимать решения и адаптироваться под стиль оппонента. За счет машинного обучения "наивные" веса вероятностной карты будут заменены на обученные, что может дать возможность боту играть по более оптимальным стратегиям.

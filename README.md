...
В ходе выполнения этого проекта, в основном, внимание было на реализацию логики бота. Остальная логика не так сложна, потому здесь о ней не идет речи. Каждый может ознакомиться с кодом и дать свои комментарии.
